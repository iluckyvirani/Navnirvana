...
// import all controller 
 ...
 import {getAllAdmin} from '../controllers/appController.js';
...
router.route('/requestcall').post( controller.addComment);
...
router.route('/getallcomment').get(controller.getAllComments); // admin get all the comments,selected service,their id
// PUT Methods
